...
const translations = {
  en: {
    ...
    settingsRestore: '🔄 Restore to Default',
    settingRestoreTitle: 'Reset All Settings',
    settingRestoreDesc: 'Reset all settings, download preferences, and history to factory defaults. This cannot be undone.',
    btnRestoreDefaults: 'Restore Defaults',
    confirmRestoreTitle: 'Restore to Default?',
    confirmRestoreDesc: 'This will reset ALL settings, download preferences, and history to factory defaults. This action cannot be undone.',
    toastRestoredDefaults: 'All settings restored to defaults! ✨',
    navAssets: 'Assets Finder',
    assetsTitle: '🖼️ Assets Finder',
    assetsDesc: 'Search and download free high-quality images and GIFs from Google and across the web.',
    assetsSearchPlaceholder: 'Search images, GIFs, aesthetics, wallpapers...',
    assetsSearchBtn: 'Search',
    assetsFilterPhotos: 'Photos',
    assetsForYou: 'For You',
    assetsForYouSub: 'Inspired by your interests',
    assetsRefreshFeed: 'Shuffle',
    assetsEmptyState: 'Search for something to discover amazing assets!',
    assetsLoadMore: 'Load More',
    assetsDownloadBtn: 'Download',
    assetsDownloading: 'Downloading...',
    assetsDownloaded: 'Saved to Downloads! ✨',
    assetsDownloadError: 'Download failed ❌',
    assetsSearching: 'Searching...',
    assetsNoResults: 'No results found. Try a different search term!',
    assetsResultsCount: '{count} results found',
    settingsAssetsApi: '🖼️ Assets Finder API Keys (Optional)',
    settingPixabayKey: 'Pixabay API Key',
    settingPixabayKeyDesc: 'Optional — Google Search works with no key. For Pixabay: sign up on pixabay.com/api/docs',
    settingGiphyKey: 'Giphy API Key',
    settingGiphyKeyDesc: 'Optional — Google Search works with no key. For Giphy: developers.giphy.com',
    assetsSetupTitle: 'Set Up API Keys',
    assetsSetupDesc: 'To use Pixabay or Giphy directly, you can provide free keys, or simply use Google search with zero setup!',
    assetsSetupPixabayStep: 'Go to <a href="https://pixabay.com/api/docs/" target="_blank">pixabay.com/api/docs</a> → Sign up → Your key appears on the page',
    assetsSetupGiphyStep: 'Go to <a href="https://developers.giphy.com/" target="_blank">developers.giphy.com</a> → Create App → Copy API key',
    assetsSetupSettingsStep: 'Paste your keys in Settings → Assets Finder API Keys',
    assetsGoSettings: 'Go to Settings',
    settingsSound: '🔊 Sound Effects (SFX)',
    settingsSoundDesc: 'Play cute and satisfying sound effects for clicks, tab navigation, and downloads.',
    settingSoundEnabled: 'Enable SFX',
    settingSoundEnabledDesc: 'Turn audio sound effects on or off',
    settingSoundVolume: 'SFX Volume',
    btnTestSound: 'Test',
  },
  th: {
    appNameShort: 'Nuutapao',
    ...
    settingsRestore: '🔄 คืนค่าเริ่มต้น',
    settingRestoreTitle: 'รีเซ็ตการตั้งค่าทั้งหมด',
    settingRestoreDesc: 'รีเซ็ตการตั้งค่า ค่าดาวน์โหลด และประวัติทั้งหมดกลับเป็นค่าเริ่มต้นจากโรงงาน ไม่สามารถย้อนกลับได้',
    btnRestoreDefaults: 'คืนค่าเริ่มต้น',
    confirmRestoreTitle: 'คืนค่าเริ่มต้น?',
    confirmRestoreDesc: 'การดำเนินการนี้จะรีเซ็ตการตั้งค่า ค่าดาวน์โหลด และประวัติทั้งหมดกลับเป็นค่าเริ่มต้น ไม่สามารถย้อนกลับได้',
    toastRestoredDefaults: 'คืนค่าเริ่มต้นทั้งหมดแล้ว! ✨',
    navAssets: 'ค้นหารูปภาพ',
    assetsTitle: '🖼️ ค้นหารูปภาพ',
    assetsDesc: 'ค้นหาและดาวน์โหลดรูปภาพและ GIF คุณภาพสูงฟรีจาก Google และทั่วทั้งเว็บ',
    assetsSearchPlaceholder: 'ค้นหารูปภาพ, GIF, ภาพพื้นหลัง, ความสวยงาม...',
    assetsSearchBtn: 'ค้นหา',
    assetsFilterPhotos: 'รูปถ่าย',
    assetsForYou: 'สำหรับคุณ',
    assetsForYouSub: 'แนะนำตามสิ่งที่คุณสนใจ',
    assetsRefreshFeed: 'สุ่มใหม่',
    assetsEmptyState: 'ค้นหาอะไรสักอย่างเพื่อค้นพบรูปภาพสุดเจ๋ง!',
    assetsLoadMore: 'โหลดเพิ่มเติม',
    assetsDownloadBtn: 'ดาวน์โหลด',
    assetsDownloading: 'กำลังดาวน์โหลด...',
    assetsDownloaded: 'บันทึกไปยังโฟลเดอร์ Downloads แล้ว! ✨',
    assetsDownloadError: 'ดาวน์โหลดล้มเหลว ❌',
    assetsSearching: 'กำลังค้นหา...',
    assetsNoResults: 'ไม่พบผลลัพธ์ ลองค้นหาคำอื่น!',
    assetsResultsCount: 'พบ {count} ผลลัพธ์',
    settingsAssetsApi: '🖼️ API Key สำหรับค้นหารูปภาพ (ไม่บังคับ)',
    settingPixabayKey: 'Pixabay API Key',
    settingPixabayKeyDesc: 'ไม่บังคับ — ค้นหาด้วย Google ได้ทันทีโดยไม่ต้องใช้ Key. สำหรับ Pixabay: pixabay.com/api/docs',
    settingGiphyKey: 'Giphy API Key',
    settingGiphyKeyDesc: 'ไม่บังคับ — ค้นหาด้วย Google ได้ทันทีโดยไม่ต้องใช้ Key. สำหรับ Giphy: developers.giphy.com',
    assetsSetupTitle: 'ตั้งค่า API Key',
    assetsSetupDesc: 'หากต้องการใช้ Pixabay หรือ Giphy โดยตรงสามารถใส่ Key ได้ หรือเลือกค้นหาด้วย Google โดยไม่ต้องใช้ Key!',
    assetsSetupPixabayStep: 'ไปที่ <a href="https://pixabay.com/api/docs/" target="_blank">pixabay.com/api/docs</a> → สมัคร → key จะแสดงบนหน้า',
    assetsSetupGiphyStep: 'ไปที่ <a href="https://developers.giphy.com/" target="_blank">developers.giphy.com</a> → สร้างแอป → คัดลอก API key',
    assetsSetupSettingsStep: 'วาง key ใน ตั้งค่า → API Key สำหรับค้นหารูปภาพ',
    assetsGoSettings: 'ไปที่ตั้งค่า',
    settingsSound: '🔊 เสียงเอฟเฟกต์ (SFX)',
    settingsSoundDesc: 'เล่นเสียงเอฟเฟกต์น่ารักสดใสสำหรับการคลิก เปลี่ยนแท็บ และดาวน์โหลด',
    settingSoundEnabled: 'เปิดใช้งาน SFX',
    settingSoundEnabledDesc: 'เปิดหรือปิดเสียงเอฟเฟกต์ในโปรแกรม',
    settingSoundVolume: 'ระดับเสียง SFX',
    btnTestSound: 'ทดสอบ',
  }
};
...
// Sound Effects (SFX) DOM Refs & Synthesizer
const quickSoundBtn = document.getElementById('quickSoundBtn');
const quickSoundIcon = document.getElementById('quickSoundIcon');
...
class CutePopSoundManager {
  ...
  loadSettings() {
    try {
      const stored = localStorage.getItem('nuutapao_sfx_settings');
      if (stored) {
  ...
  saveSettings() {
    try {
      localStorage.setItem('nuutapao_sfx_settings', JSON.stringify({
  ...
  // Cute bubble pop for tab switches (playful two-tone upward pop)
  playTab() {
  ...
  // Playful high bubble pop (filter chips, theme switches)
  playPop() {
    if (!this.enabled) return;
    try {
      this.init();
  ...
  // Soft airy swoop for modal opening, lightbox, or drawer
  playWhoosh() {
    if (!this.enabled) return;
    try {
      this.init();
  ...
  // Cheerful Kawaii ascending 3-note arpeggio (C5 -> E5 -> G5 -> C6)
  playSuccess() {
    if (!this.enabled) return;
    try {
      this.init();
      ...
      notes.forEach((freq, i) => {
        const t = this.ctx.currentTime + i * 0.065;
        const osc = this.ctx.createOscillator();
        const gain = this.ctx.createGain();
        ...
        gain.gain.setValueAtTime(0.001, t);
        gain.gain.linearRampToValueAtTime(0.18, t + 0.018);
  ...
  // Celebratory victory chime on download or conversion complete
  playComplete() {
    if (!this.enabled) return;
    try {
      this.init();
      if (!this.ctx) return;
      const notes = [
        { f: 587.33, d: 0.10, pause: 0 },    // D5
        { f: 783.99, d: 0.10, pause: 0.08 }, // G5
        { f: 880.00, d: 0.10, pause: 0.16 }, // A5
        { f: 1174.66, d: 0.38, pause: 0.25 } // D6 (held victory bell)
      ];
      notes.forEach(n => {
        const t = this.ctx.currentTime + n.pause;
        const osc = this.ctx.createOscillator();
        const gain = this.ctx.createGain();
  ...
  // Gentle cute cartoon error boing
  playError() {
    if (!this.enabled) return;
    try {
      this.init();
...
const sfx = new CutePopSoundManager();
window.sfx = sfx;

// Resume audio on first user interaction (browser policy compliant)
['click', 'keydown', 'touchstart'].forEach(evt => {
  window.addEventListener(evt, () => sfx.init(), { once: true, passive: true });
});

// Assets Finder DOM Refs
const assetsSearchInput = document.getElementById('assetsSearchInput');
const assetsSearchClear = document.getElementById('assetsSearchClear');
const assetsSearchBtn = document.getElementById('assetsSearchBtn');
const assetsGrid = document.getElementById('assetsGrid');
const assetsEmptyState = document.getElementById('assetsEmptyState');
const assetsFilters = document.getElementById('assetsFilters');

const assetsResultsInfo = document.getElementById('assetsResultsInfo');
const assetsResultCount = document.getElementById('assetsResultCount');
const assetsLoadMore = document.getElementById('assetsLoadMore');
const assetsLoadMoreBtn = document.getElementById('assetsLoadMoreBtn');
const assetsLightbox = document.getElementById('assetsLightbox');
const assetsLightboxBackdrop = document.getElementById('assetsLightboxBackdrop');
const assetsLightboxClose = document.getElementById('assetsLightboxClose');
const assetsLightboxImg = document.getElementById('assetsLightboxImg');
const assetsLightboxAuthor = document.getElementById('assetsLightboxAuthor');
const assetsLightboxSource = document.getElementById('assetsLightboxSource');
const assetsLightboxSize = document.getElementById('assetsLightboxSize');
const assetsLightboxTags = document.getElementById('assetsLightboxTags');
const assetsResolutionSelect = document.getElementById('assetsResolutionSelect');
const assetsDownloadBtn = document.getElementById('assetsDownloadBtn');
...
function toast(msg, type = 'info') {
  ...
  else if (type === 'error') sfx.playError();
  else sfx.playPop();
...
function setActiveTab(targetTab) {
  ...
  if (targetTab === 'assets') {
    if (!assetsState.items || assetsState.items.length === 0) {
...
// Curated Gen Z favorite starter pools (Strictly non-AI photography & viral meme/aesthetic GIF vibes)
const DISCOVERY_PHOTO_POOLS = [
  '35mm film photography aesthetic -ai -"ai generated"',
  'cute silly cat meme photo -ai -"ai generated"',
  'y2k vintage aesthetic photography -ai -"ai generated"',
  'retro 90s anime scenery aesthetic',
  'ghibli peaceful scenery landscape',
  'golden hour sunset 35mm film photography -ai -"ai generated"',
  'vintage disposable camera aesthetic -ai -"ai generated"',
  'chill capybara photography -ai -"ai generated"',
  'tokyo night city street film photography -ai -"ai generated"',
  'funny orange cat photos -ai -"ai generated"',
  'cozy vintage room record player aesthetic -ai -"ai generated"',
  'matcha latte cozy cafe film photography -ai -"ai generated"',
  'golden retriever silly puppy photos -ai -"ai generated"',
  'polaroid vintage summer aesthetic -ai -"ai generated"'
];

const DISCOVERY_GIF_POOLS = [
  'funny cat meme gif',
  'iconic reaction meme gif',
  'retro 90s anime aesthetic gif',
  'dancing cat cute gif',
  'relatable mood reaction gif',
  'pedro raccoon meme gif',
  'ghibli peaceful aesthetic gif',
  'chill anime lofi loop gif',
  'funny dog silly moment gif',
  'pop cat meme cute gif',
  'kawaii kitten meme gif',
  'confused cat meme gif',
  'funny hamster meme gif'
];

const USER_INTERESTS_STORAGE_KEY = 'nuutapao_user_interests_v1';

function getLearnedInterests() {
  try {
    const raw = localStorage.getItem(USER_INTERESTS_STORAGE_KEY);
    if (raw) return JSON.parse(raw);
  } catch {}
  return { tags: {}, lastUpdated: Date.now() };
}

function saveLearnedInterests(data) {
  try {
    localStorage.setItem(USER_INTERESTS_STORAGE_KEY, JSON.stringify(data));
  } catch {}
}

function recordUserInterests(keywords, weight = 1) {
  if (!keywords) return;
  const words = Array.isArray(keywords)
    ? keywords
    : String(keywords).toLowerCase().split(/[\s,._\-+/\\]+/);
  const data = getLearnedInterests();
  const stopWords = new Set([
    'the', 'and', 'with', 'for', 'from', 'this', 'that', 'image', 'picture', 'photo',
    'free', 'high', 'view', 'wallpapers', 'wallpaper', 'download', 'best', 'gif', 'gifs',
    'com', 'net', 'org', 'www', 'http', 'https', 'stock', 'vector', 'illustration'
  ]);

  words.forEach(raw => {
    const w = raw.trim().toLowerCase();
    if (w.length < 3 || stopWords.has(w) || /^\d+$/.test(w)) return;
    data.tags[w] = (data.tags[w] || 0) + weight;
  });

  // Keep top 60 tags
  const sorted = Object.entries(data.tags).sort((a, b) => b[1] - a[1]);
  if (sorted.length > 60) {
    data.tags = Object.fromEntries(sorted.slice(0, 60));
  }
  data.lastUpdated = Date.now();
  saveLearnedInterests(data);
}

function getTopInterestTags(count = 6) {
  const data = getLearnedInterests();
...
function pickDiscoveryBatch(count = 5) {
  const isGif = assetsState.type === 'gif';
  const basePool = isGif ? DISCOVERY_GIF_POOLS : DISCOVERY_PHOTO_POOLS;
  const pool = [...basePool];
  const topTags = getTopInterestTags(6);

  // If user has learned interests, mix them into the candidate pool
  if (topTags.length > 0) {
    topTags.forEach(tag => {
      if (isGif) {
        pool.push(`${tag} funny meme gif`);
        pool.push(`${tag} reaction gif`);
      } else {
        pool.push(`${tag} 35mm film photography -ai -"ai generated"`);
        pool.push(`${tag} vintage aesthetic photography -ai -"ai generated"`);
        pool.push(`${tag} cute funny photos -ai -"ai generated"`);
      }
    });
  }

  // Shuffle candidate pool and pick `count` distinct diverse topics
  return shuffleArray(pool).slice(0, count);
}

async function loadDiscoveryFeed(append = false) {
  if (assetsState.loading) return;
  assetsState.isDiscovery = true;

  if (!append) {
    assetsState.page = 1;
    assetsState.items = [];
    showAssetsShimmer(12);
  }

  if (assetsResultsInfo) assetsResultsInfo.classList.add('hidden');
  if (assetsSearchClear) assetsSearchClear.classList.add('hidden');

  assetsState.loading = true;
  if (assetsLoadMoreBtn) assetsLoadMoreBtn.disabled = true;

  try {
    // Pick 5 distinct diverse topics from the pool for a rich, shuffled Pinterest feed
    const batchQueries = pickDiscoveryBatch(5);
    const perTopic = 6;

    const fetchPromises = batchQueries.map(q => {
      const params = new URLSearchParams({
        q,
        source: assetsState.source,
        type: assetsState.type,
        page: assetsState.page,
        per_page: perTopic
      });
      return fetch(`/api/assets/search?${params}`)
        .then(res => res.json())
    ...
    // Interleave results from each topic so items are varied and distributed
    const seenUrls = new Set(assetsState.items.map(it => it.preview || it.thumbnail || it.id));
    const interleaved = [];
    const maxLen = Math.max(0, ...results.map(r => r.length));

    for (let i = 0; i < maxLen; i++) {
      for (const topicItems of results) {
        if (topicItems[i]) {
          const item = topicItems[i];
          const key = item.preview || item.thumbnail || item.id;
          if (!seenUrls.has(key)) {
            seenUrls.add(key);
    ...
    // Thoroughly shuffle the batch for full variety across the grid
    const newItems = shuffleArray(interleaved);

    assetsState.total = 150;
    assetsState.items = append ? [...assetsState.items, ...newItems] : newItems;

    renderAssetsGrid(newItems, append);

    const hasMore = assetsState.items.length < assetsState.total && newItems.length > 0;
    if (assetsLoadMore) assetsLoadMore.classList.toggle('hidden', !hasMore);
    if (assetsEmptyState) assetsEmptyState.classList.add('hidden');
  } catch (err) {
    console.error('Discovery feed error:', err);
  } finally {
    assetsState.loading = false;
    if (assetsLoadMoreBtn) assetsLoadMoreBtn.disabled = false;
  }
}

function showAssetsShimmer(count = 12) {
  const heights = [180, 220, 260, 200, 240, 300, 190, 250, 210, 270, 230, 280];
  let html = '';
  for (let i = 0; i < count; i++) {
    html += `<div class="asset-card-shimmer" style="height:${heights[i % heights.length]}px"></div>`;
  }
...
function renderAssetCard(item) {
  ...
  card.innerHTML = `
    ...
    <button class="asset-card-download" title="Quick Download">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
    </button>
    ${item.type === 'gif' ? '<span class="asset-card-gif-badge">GIF</span>' : ''}
  `;

  // Click card → learn interest and open lightbox
  card.addEventListener('click', (e) => {
    if (e.target.closest('.asset-card-download')) return;
    const keywords = (item.tags || []).concat((item.title || '').split(' '));
    recordUserInterests(keywords, 2);
    openAssetsLightbox(item);
  });

  // Quick download button
  const dlBtn = card.querySelector('.asset-card-download');
  dlBtn.addEventListener('click', (e) => {
    e.stopPropagation();
    const keywords = (item.tags || []).concat((item.title || '').split(' '));
    recordUserInterests(keywords, 4);
    quickDownloadAsset(item, dlBtn);
  });

  return card;
}

function renderAssetsGrid(items, append = false) {
  if (!append) {
  ...
  if (items.length === 0 && !append) {
    assetsGrid.innerHTML = `
      <div class="assets-empty-state">
        ...
        <p>${t('assetsNoResults')}</p>
      </div>
    `;
    return;
  }
  items.forEach(item => {
    assetsGrid.appendChild(renderAssetCard(item));
  });
}

async function searchAssets(append = false) {
  const q = assetsSearchInput.value.trim();
  if (!q) {
    if (assetsSearchClear) assetsSearchClear.classList.add('hidden');
    loadDiscoveryFeed(false);
    return;
  ...
  assetsState.isDiscovery = false;
  if (assetsSearchClear) assetsSearchClear.classList.remove('hidden');

  // Record query into learned interests (+3 weight)
  recordUserInterests(q, 3);
  ...
  assetsState.query = q;
  assetsState.loading = true;
  assetsSearchBtn.disabled = true;
  assetsSearchBtn.textContent = t('assetsSearching');
  if (assetsLoadMoreBtn) assetsLoadMoreBtn.disabled = true;
  ...
  try {
    ...
    // Show setup guide if API key is missing for Pixabay/Giphy
    if (data.setup_required) {
      const source = data.setup_required;
      assetsGrid.innerHTML = `
        <div class="assets-setup-guide">
          <div class="assets-setup-icon">🔑</div>
          <h3>${t('assetsSetupTitle')}</h3>
          <p>${t('assetsSetupDesc')}</p>
          <div class="assets-setup-steps">
            <div class="assets-setup-step">
              <span class="assets-setup-step-num">1</span>
              <span>${source === 'giphy' ? t('assetsSetupGiphyStep') : t('assetsSetupPixabayStep')}</span>
            </div>
            <div class="assets-setup-step">
              <span class="assets-setup-step-num">2</span>
              <span>${t('assetsSetupSettingsStep')}</span>
            </div>
          </div>
          <button class="btn-go-settings" onclick="setActiveTab('settings'); saveActiveTab('settings');">${t('assetsGoSettings')}</button>
        </div>
      `;
      assetsResultsInfo.classList.add('hidden');
      assetsLoadMore.classList.add('hidden');
      return;
    }

    assetsState.total = data.total;
    assetsState.items = append ? [...assetsState.items, ...data.items] : data.items;

    renderAssetsGrid(data.items, append);

    // Results info
    assetsResultsInfo.classList.remove('hidden');
    assetsResultCount.textContent = t('assetsResultsCount').replace('{count}', assetsState.total.toLocaleString());

    // Show/hide load more
    const hasMore = assetsState.items.length < assetsState.total;
    assetsLoadMore.classList.toggle('hidden', !hasMore);
    assetsEmptyState?.classList.add('hidden');
  } catch (err) {
    toast('Search failed: ' + err.message, 'error');
  } finally {
    assetsState.loading = false;
    assetsSearchBtn.disabled = false;
    assetsSearchBtn.textContent = t('assetsSearchBtn');
    if (assetsLoadMoreBtn) assetsLoadMoreBtn.disabled = false;
  }
}

function openAssetsLightbox(item) {
  assetsState.currentItem = item;
  assetsLightboxImg.src = item.preview || item.thumbnail;
  assetsLightboxAuthor.textContent = '📷 ' + item.author;
  if (assetsLightboxSource) {
    assetsLightboxSource.textContent = item.type === 'gif' ? 'GIF' : 'PHOTO';
    assetsLightboxSource.className = 'assets-lightbox-source ' + (item.type === 'gif' ? 'giphy' : 'google');
  }
  assetsLightboxSize.textContent = item.width && item.height ? `${item.width} × ${item.height}` : '';

  // Tags
  assetsLightboxTags.innerHTML = '';
  (item.tags || []).forEach(tag => {
    const el = document.createElement('span');
    el.className = 'assets-lightbox-tag';
    el.textContent = tag;
    assetsLightboxTags.appendChild(el);
  });

  // Resolution select
  const origOption = assetsResolutionSelect.querySelector('option[value="original"]');
  if (origOption) origOption.style.display = item.urls.original ? '' : 'none';

  assetsLightbox.classList.remove('hidden');
  sfx.playWhoosh();
}

function closeAssetsLightbox() {
  assetsLightbox.classList.add('hidden');
  assetsState.currentItem = null;
  sfx.playClick();
}

async function quickDownloadAsset(item, btnEl) {
  const url = item.urls.large || item.urls.medium || item.urls.original || item.thumbnail;
  const ext = item.type === 'gif' ? '.gif' : '.jpg';
  ...
  try {
    ...
    const data = await res.json();
    if (data.success) {
      toast(t('assetsDownloaded'), 'success');
    } else {
      toast(data.error || t('assetsDownloadError'), 'error');
    }
  } catch {
    toast(t('assetsDownloadError'), 'error');
  } finally {
    if (btnEl) {
      btnEl.style.opacity = '';
...
async function downloadAssetFromLightbox() {
  const item = assetsState.currentItem;
  if (!item) return;

  const resolution = assetsResolutionSelect.value;
  const url = item.urls[resolution] || item.urls.large || item.urls.medium || item.thumbnail;
  const ext = item.type === 'gif' ? '.gif' : (item.type === 'vector' ? '.svg' : '.jpg');
  const filename = `${item.source}_${item.id}_${resolution}${ext}`;

  // Record user interest (+4)
  const keywords = (item.tags || []).concat((item.title || '').split(' '));
  recordUserInterests(keywords, 4);

  assetsDownloadBtn.disabled = true;
  const origText = assetsDownloadBtn.querySelector('span');
  if (origText) origText.textContent = t('assetsDownloading');
  ...
  try {
    ...
    assetsDownloadBtn.disabled = false;
    if (origText) origText.textContent = t('assetsDownloadBtn');
  }
}

// Wire up Assets Finder events
if (assetsSearchBtn) {
  assetsSearchBtn.addEventListener('click', () => searchAssets());
}
if (assetsSearchInput) {
  ...
  assetsSearchInput.addEventListener('input', () => {
    if (assetsSearchClear) {
      assetsSearchClear.classList.toggle('hidden', !assetsSearchInput.value.trim());
    }
  });
}
if (assetsSearchClear) {
  assetsSearchClear.addEventListener('click', () => {
    ...
    assetsSearchClear.classList.add('hidden');
    loadDiscoveryFeed(false);
  });
}

// Filter chips (Photos / GIFs)
if (assetsFilters) {
  assetsFilters.querySelectorAll('.assets-filter-chip').forEach(chip => {
    chip.addEventListener('click', () => {
      sfx.playPop();
      assetsFilters.querySelectorAll('.assets-filter-chip').forEach(c => c.classList.remove('active'));
      chip.classList.add('active');
      const type = chip.dataset.type;
      assetsState.type = type;
      assetsState.source = 'google';

      if (assetsSearchInput && assetsSearchInput.value.trim()) {
        searchAssets();
      } else {
        loadDiscoveryFeed(false);
      }
...
// Load more button
if (assetsLoadMoreBtn) {
  assetsLoadMoreBtn.addEventListener('click', () => {
    assetsState.page++;
    if (assetsState.isDiscovery) {
      loadDiscoveryFeed(true);
    } else {
      searchAssets(true);
    }
  });
...
// Lightbox events
if (assetsLightboxClose) {
  assetsLightboxClose.addEventListener('click', closeAssetsLightbox);
}
if (assetsLightboxBackdrop) {
  assetsLightboxBackdrop.addEventListener('click', closeAssetsLightbox);
}
if (assetsDownloadBtn) {
  assetsDownloadBtn.addEventListener('click', downloadAssetFromLightbox);
}
document.addEventListener('keydown', (e) => {
  if (e.key === 'Escape' && !assetsLightbox.classList.contains('hidden')) {
    closeAssetsLightbox();
  }
});
...
function applySettings() {
  ...
  // 8. Assets Finder API Keys
  const pxInput = document.getElementById('pixabayApiKeyInput');
  const gpInput = document.getElementById('giphyApiKeyInput');
  if (pxInput) pxInput.value = state.settings.pixabayApiKey || '';
  if (gpInput) gpInput.value = state.settings.giphyApiKey || '';

  // 9. Sound Effects
  if (soundEffectsToggle) soundEffectsToggle.checked = sfx.enabled;
  if (quickSoundIcon) quickSoundIcon.textContent = sfx.enabled ? '🔊' : '🔇';
  if (quickSoundBtn) quickSoundBtn.title = sfx.enabled ? 'Sound Enabled (Click to mute)' : 'Sound Muted (Click to unmute)';
  if (soundVolumeSlider) soundVolumeSlider.value = Math.round(sfx.volume * 100);
  if (soundVolumeLabel) soundVolumeLabel.textContent = `${Math.round(sfx.volume * 100)}%`;
}
...
if (quickSoundBtn) {
  quickSoundBtn.addEventListener('click', () => {
    ...
    applySettings();
    if (sfx.enabled) sfx.playSuccess();
  });
}
...
if (soundVolumeSlider) {
  soundVolumeSlider.addEventListener('input', (e) => {
    ...
    if (soundVolumeLabel) soundVolumeLabel.textContent = `${val}%`;
  });
}
...
// API Key inputs for Assets Finder
...
if (pixabayApiKeyInput) {
  pixabayApiKeyInput.addEventListener('change', () => {
    state.settings.pixabayApiKey = pixabayApiKeyInput.value.trim();
    saveSettings();
  });
}
if (giphyApiKeyInput) {
  giphyApiKeyInput.addEventListener('change', () => {
    state.settings.giphyApiKey = giphyApiKeyInput.value.trim();
    saveSettings();
  });
}

// Restore to Default button in settings
const restoreDefaultsBtn = document.getElementById('restoreDefaultsBtn');
if (restoreDefaultsBtn) {
  restoreDefaultsBtn.addEventListener('click', async () => {
    const confirmed = await showConfirm('confirmRestoreTitle', 'confirmRestoreDesc');
    if (confirmed) {
      try {
        const res = await fetch('/api/restore-defaults', { method: 'POST' });
        const fresh = await res.json();
        // Apply the fresh state to the UI
        if (fresh.settings) {
          state.settings = { ...state.settings, ...fresh.settings };
        }
        if (fresh.downloadDefaults) {
          if (fresh.downloadDefaults.savePath) {
            state.savePath = fresh.downloadDefaults.savePath;
            const savePathInput = document.getElementById('savePathInput');
            if (savePathInput) savePathInput.value = state.savePath;
          }
          if (fresh.downloadDefaults.converterSavePath) {
            state.converterSavePath = fresh.downloadDefaults.converterSavePath;
            const converterSavePathInput = document.getElementById('converterSavePathInput');
            if (converterSavePathInput) converterSavePathInput.value = state.converterSavePath;
          }
          if (fresh.downloadDefaults.format) {
            state.format = fresh.downloadDefaults.format;
            formatBtns.forEach(btn => {
              btn.classList.toggle('active', btn.dataset.val === state.format);
            });
          }
          if (qualitySelect) qualitySelect.value = fresh.downloadDefaults.quality || 'best';
          if (thumbnailToggle) thumbnailToggle.checked = fresh.downloadDefaults.embedThumbnail !== false;
        }
        serverHistory = fresh.history || [];
        renderDownloads();
        renderHistoryTab();
        applySettings();
        toast(t('toastRestoredDefaults'), 'success');
      } catch {}
    }
  });
}
    ...
    try {
      const res = await fetch('/api/download', {
        ...
        body: JSON.stringify({
          ...
          section: `${startFormatted}-${endFormatted}`,
